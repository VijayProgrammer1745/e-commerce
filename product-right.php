...
<head>
    <meta charset="utf-8">
    <title>Ramdev PCB - Products</title>
        ...
        <section class="mt-50 mb-50">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="widget-category mb-30">
                            <h5 class="section-title style-1 mb-30 wow fadeIn animated animated animated" style="visibility: visible;">Category</h5>
                        <!-- Fillter By Price -->
                        <div>
                            <?php $query5 = "select * from BrandCategory";
	            ...
	            while ($row6 = mysqli_fetch_assoc($result6)) {
                                ...
                                <ul class="categories">
                                <li style="border-bottom:1px solid #cdc8c8;padding:5px"><a href="#"><?= ucwords(strtolower($subname)) ?></a></li>
                                </ul>
                                <?php } ?>
                            </div>
                            <?php } ?>
      ...
      contente.style.maxHeight = contente.scrollHeight + "px";
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="row product-grid-3">
                            <?php 
                            $query = "SELECT a.ProductID,a.ProductNumber,a.Watts,a.Driver,a.BtoCPrice,a.BtoBPrice1,b.Model,c.SubCategory,d.Category from productdetails a inner join BrandModel b on a.ModelID=b.ModelID INNER join BrandSubCategory c on a.SubCategoryID=c.SubCategoryID INNER JOIN BrandCategory d on a.CategoryID=d.CategoryID where a.is_deleted='0'";
        ...
        echo "Error : " .$query. "<br>" . $conn->error;
                            ...
                            $result3 = mysqli_query($conn, "SELECT * FROM productimages WHERE ProductID = '$productId' LIMIT 1") or die(mysqli_error($conn));
                                            ...
                                            $image = !empty($row3['ImageName']) ? $row3['ImageName'] : 'https://admin.ramdevpcb.com/assets/images/product_images/default_product.png';

                                            ?>
                            <div class="col-lg-4 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom" style="border:1px solid #cce7d0">
                                            <a href="Product_Details.php?id=<?php echo $row2['ProductID'] ?>">
                                                <img class="default-img" src="<?php echo $image ?>" alt="">
                                                <img class="hover-img" src="<?php echo $image ?>" alt="">
                                            </a>
                                        </div>
...
<i class="fi-rs-search"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop-grid-right.html"><?php echo $row2['Category'] ?></a>
                                        </div>
                                        <h2><a href="Product_Details.php?id=<?php echo $row2['ProductID'] ?>"><?php echo $row2['SubCategory'] . ' '.$row2['Model'].' '.$row2['Driver']. ' (' . $row2['Watts'] .')' ?></a></h2>
                                        ...
                                        <div class="product-price">
                                            <span>&#8377;<?php echo $row2['BtoBPrice1'] ?></span>
    ...
    <footer class="main">
        <section class="newsletter p-30 text-white wow fadeIn animated" style="background: darkgoldenrod;">
            <div class="container">
                <div class="row align-items-center">
